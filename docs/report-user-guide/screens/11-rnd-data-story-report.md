...
INFO_IDS: `rnd.leave_adjusted_capacity`, `rnd.total_leaves_planned`, `rnd.pending_hours_required`
...
| Total Leaves Planned | Planned leave load in selected range. | `Planned Taken + Planned Not Yet Taken` | planned taken, planned not yet taken | Uses day-bucketed leave rows in selected range. | RLT total planned leaves and nested adjusted capacity. |
