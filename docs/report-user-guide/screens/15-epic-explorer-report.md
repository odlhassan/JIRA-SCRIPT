...
| Table | SV Hours | Signed hours and percent | Blank when no planned basis | Actual-to-date hours minus planned-to-date hours. Planned-to-date is prorated through Actual Complete Date for resolved epics and through today for unresolved and reopened epics; it reaches the full original estimate after the planned due date. |
