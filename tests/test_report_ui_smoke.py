...
class ReportUiSmokeTests(unittest.TestCase):
    ...
    def test_planned_vs_dispensed_page_controls_exist(self):
        ...
        self.assertIn('class="item-col"', html)
        self.assertIn("col-resize-handle", html)
        self.assertIn("/api/planned-vs-dispensed/ui-settings", html)
        self.assertIn("Dispensed Start", html)
        self.assertIn("Dispensed Due", html)
        self.assertIn('data-info-id="planned_vs_dispensed.planned_hours"', html)
        self.assertIn("row-toggle", html)
        self.assertIn('data-row-type="${esc(row.rowType)}"', html)
