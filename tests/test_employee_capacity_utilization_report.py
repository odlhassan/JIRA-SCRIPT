...
class EmployeeCapacityUtilizationReportTests(unittest.TestCase):
    def test_report_has_standalone_filters_and_canonical_payload(self):
        ...
        self.assertIn("filter-topline", html)
        self.assertIn("filter-main", html)
        self.assertIn("filter-preferences", html)
        self.assertIn("Display &amp; inclusion", html)
        self.assertIn("Updates instantly", html)
        self.assertIn('id="filter-toggle"', html)
        self.assertIn('id="filter-summary"', html)
        self.assertIn("function setFiltersCollapsed(collapsed)", html)
        self.assertIn("FILTER_COLLAPSED_KEY", html)
        self.assertIn("overflow:visible!important", html)
        self.assertIn("team-options{z-index:62!important}", html)
        ...
        self.assertIn("function worklogTypeIcon(issueType)", html)
        self.assertIn("bug_report", html)
        self.assertIn("Not a subtask or bug subtask", html)
        self.assertIn("headers=['Type','Work item'", html)
