...
class EmployeePerformanceReportTests(unittest.TestCase):
    ...
    def test_html_contains_core_controls(self):
        ...
        self.assertNotIn("Not resigned", html)
        ...
        self.assertIn('id="settings-filter-toggle"', html)
        self.assertIn('id="settings-filter-menu"', html)
        self.assertIn('id="epic-basis-tk"', html)
        self.assertIn('id="epic-basis-subtask"', html)
    ...
    def test_html_uses_shared_scoped_subtasks_endpoint_for_filter_refresh(self):
        ...
        self.assertIn('params.set("scope_basis", epicDateBasisMode);', html)
