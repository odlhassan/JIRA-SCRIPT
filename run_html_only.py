...
- Syncs static source reports such as monthly_epic_plan_progress_report.html
  into REPORT_HTML_DIR after generator-backed reports complete.
"""
...
DEFAULT_HTML_ONLY_STEPS: list[tuple[str, str]] = [
    ...
    ("employee-capacity-utilization-html", "generate_employee_capacity_utilization_report.py"),
    ("support-center-html", "generate_support_center_report.py"),
